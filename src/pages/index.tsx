  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Community Platform - Engage, Learn, and Connect. Consume content, chat one-on-one, join forums, and build relationships just like on Facebook. A new era of community interaction."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1687360441027-27e70655b27e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MXwxfHNlYXJjaHwxfHxjb21tdW5pdHl8ZW58MHx8fHwxNjk1Mjc0NDM0fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Community Platform - Engage, Learn, and Connect. Consume content, chat one-on-one, join forums, and build relationships just like on Facebook. A new era of community interaction.`}
            </Text>
            <Box
