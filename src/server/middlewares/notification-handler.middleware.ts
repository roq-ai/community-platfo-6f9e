...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'content.create.create': {
    roles: ['administrator', 'moderator', 'subscriber'],
    key: 'contentId',
    tenantPath: [],
    userPath: [],
  },
  'content.flag.update': {
    roles: ['administrator', 'content-creator'],
    key: 'contentId',
    tenantPath: [],
    userPath: [],
  },
  'comment.create.create': {
    roles: ['administrator', 'content-creator', 'moderator'],
    key: 'commentId',
    tenantPath: [],
    userPath: [],
  },
...
const tenantRoles: string[] = ['administrator', 'content-creator', 'moderator', 'subscriber', 'guest'];
